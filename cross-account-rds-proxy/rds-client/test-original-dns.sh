...
# Test accessing RDS Proxy via original DNS name
...
echo "=== Testing RDS Proxy via Original DNS Name ==="
echo ""

echo "Testing: rds-proxy.proxy-cpo0q8m8sxzx.ap-northeast-1.rds.amazonaws.com"
